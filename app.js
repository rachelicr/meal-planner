...
function App() {
  ...
  if (loading) return (
    <div style={{ minHeight: "100vh", background: "#eaa613", display: "flex", alignItems: "center", justifyContent: "center" }}>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#eaa613", fontFamily: "Georgia, serif", paddingBottom: 40 }}>
      <div style={{
        background: "linear-gradient(135deg, #1a2e1a 0%, #eaa613 60%, #3d6b3d 100%)",
